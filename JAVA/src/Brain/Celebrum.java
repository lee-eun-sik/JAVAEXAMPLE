...
public class Celebrum extends Brain {
	

	private String function1;
	private String Think;
	private String language;
	public  Celebrum(String name, String function, String similarity, String function1, String Think, String language) {
	...
	public String function() {
		String result= "Cerebrum ["+"function1=" + function1 + "Think=" + Think + "language=" + language + "]"+
				"Brain [name=" + super.getName() + "function="+ super.getFunction() + "similarity=" + super.getSimilarity()+"]";
