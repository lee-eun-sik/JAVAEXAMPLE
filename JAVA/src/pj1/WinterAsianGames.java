...
public class WinterAsianGames {
	...
	public WinterAsianGames(String MajorVenue,
	...
	public String WinterAsianGamesInfo() {
		return "WinterAsianGames [MajorVenue :" + " "+ MajorVenue +" "+ "the_date_of_the_first_competition : " + " " + the_date_of_the_first_competition 
				+ " "+ "Season : " + " " + Season + " " +"the_cycle_of_holding_a_contest :" + " " + the_cycle_of_holding_a_contest;	
	}
	...
	public void setWinter(String Season) {
		this.Season = Season;
	}
