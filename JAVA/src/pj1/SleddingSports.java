...
public class SleddingSports extends IceSports{
	...
	public SleddingSports(
		...
		super(MajorVenue, the_date_of_the_first_competition, Season, the_cycle_of_holding_a_contest, Alpine_Skiing, Cross_Country_Skiing, Freestyle_Skiing,
				Snowboarding, Ski_Jumping, Nordic_Combined, Figure_Skating, Short_Track_Speed_Skating, Speed_Skaiting, Ice_Hockey, Curling);
	...
	public String WinterAsianGamesInfo() {
		...
		+ "IceSports [Figure_Skating : " + " " + super.getFreestyle_Skiing() + "Short_Track_Speed_Skating : " + " " + super.getShort_Track_Speed_Skating() + "Speed_Skaiting : " + " " + super.getSpeed_Skaiting()
