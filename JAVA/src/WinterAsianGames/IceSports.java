...
public class IceSports extends SnowSports{
	...
	public String Short_Track_Speed_Skaiting;
	...
	public IceSports(
		...
		this.Short_Track_Speed_Skaiting = Short_Track_Speed_Skating;
	...
	public String WinterAsianGamesInfo() {
		return "WinterAsianGames [MajorVenue :" + " "+ super.getMajorVenue() + "the_date_of_the_first_competition : " + " " + super.getThe_date_of_the_first_competition() 
				...
				+ "IceSports [Figure_Skating : " + " " + Figure_Skating + "Short_Track_Speed_Skating : " + " " + Short_Track_Speed_Skaiting + "Speed_Skaiting : " + " " + Speed_Skaiting
	...
	public String getShort_Track_Speed_Skaiting() {
		return Short_Track_Speed_Skaiting;
	}

	public void setShort_Track_Speed_Skaiting(String short_Track_Speed_Skaiting) {
		Short_Track_Speed_Skaiting = short_Track_Speed_Skaiting;
	}
