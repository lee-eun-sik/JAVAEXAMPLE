...
public class SnowSports extends WinterAsianGames {
	...
	private String Figure_Skaiting;
	public SnowSports() {
	...
	public SnowSports(
		...
		this.Figure_Skaiting = Figure_Skating;
		
	}
	
	public String WinterAsianGamesInfo() {
		return "WinterAsianGames [MajorVenue : " + " "+ super.getMajorVenue() + " "+
			"the_date_of_the_first_competition : " + " " + super.the_date_of_the_first_competition + " " 
				+ "Season : " + " " + super.Season + " " + "the_cycle_of_holding_a_contest :" + " " +
			super.the_cycle_of_holding_a_contest + "]" + "SnowSports [Alpine_Skiing : " + " " + Alpine_Skiing +" "+ "Cross_Country_Skiing :" +
				" " + Cross_Country_Skiing + " "+ "Freestyle_Skiing :" + " " + Freestyle_Skiing + " " + "Snowboarding : " + " " + Snowboarding + " " + "Ski_Jumping : " + " " + Ski_Jumping +
	...
	public String getFigure_Skaiting() {
		return Figure_Skaiting;
	}
	public void setFigure_Skaiting(String figure_Skaiting) {
		Figure_Skaiting = figure_Skaiting;
	}
